...
const reviews: Review[] = [
  {
    id: 1,
    author: "Алексей М.",
    text: "Александр Иванович блестяще провёл моё дело. Ситуация казалась безнадёжной, но благодаря грамотной защите обвинение было переквалифицировано, а я получил условный срок. Профессионализм высшего класса.",
    rating: 5,
    date: "2025-12-10",
  },
  {
